...
/**
 * Extends the possibilities of {@link Option} to parse a POJO from a JSON input
 * file.
 * 
 * Instead of writing
 * 
 ...
 * </pre>
 * 
 * and then parsing the JSON file manually in the {@code FeatureRunner.execute()} method, you
 * can write
 * 
 * <pre>
