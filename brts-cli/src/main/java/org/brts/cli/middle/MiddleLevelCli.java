...
public class MiddleLevelCli {
	...
	static {
		...
		dispatcher.register(new BuildCli.Run()).register(new ScanPlaylistsCli.Run()).register(new DsPreviewCli.Run())
				.register(new SetupMenuCli.Run()).register(new FindFirstPlaylistCli.Run());
	}
