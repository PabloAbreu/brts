...
public class SetupMenuCli {
    ...
    static class Options {
        @Option(name = "--descriptor", required = true,
                usage = "Path to the setup menu JSON descriptor")
        File descriptor;
    ...
    public static class Run extends FeatureRunner<Options> {
        @Override public String getCommandName() { return "create-setup-menu"; }
        @Override public String getDescription() { return "Generate a Blu-ray setup/settings menu M2TS"; }
