...
public class LowLevelDispatcher {
	...
	public LowLevelDispatcher() {
		...
		dispatcher.register(new ClipInfoCli.Parse()).register(new ClipInfoCli.Write())
				...
				.register(new MkvCli.Info()).register(new Mp4Cli.Info()).register(new M2tsCli.Info())
				.register(new M2tsCli.Extract()).register(new M2tsCli.Create()).register(new M2tsCli.Dump())
				.register(new M2tsCli.IgsDemux()).register(new M2tsCli.M2tsIgsMux()).register(new M2tsCli.IgsMux())
				.register(new PgsCli.Create()).register(new RleConverterCli.Convert())
