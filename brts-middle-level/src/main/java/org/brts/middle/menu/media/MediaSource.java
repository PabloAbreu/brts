...
/**
 * Abstraction for extracting elementary streams (video, audio) from a container media
 * file to be used as background content in a setup menu.
 * <p>
 * Implementations handle specific container formats (MKV, MP4, etc.). The extracted
 * elementary streams are written as raw files suitable for feeding into
 * {@link org.brts.common.m2ts.M2tsWriter}.
 */
public interface MediaSource {
	 ...
	 * @param audioEsFile path to the extracted raw audio ES file (may be null if no
	 * audio)
	 * @param videoStreamTypeByte ISO 13818-1 stream_type for the video (e.g. 0x1B for
	 * H.264)
	 * @param audioStreamTypeByte ISO 13818-1 stream_type for the audio (e.g. 0x81 for
	 * AC3)
	...
	/**
	 * Extracts the video and audio elementary streams from the source media into the
