...
/**
 * Abstraction for extracting elementary streams (video, audio) from a
 * container media file to be used as background content in a setup menu.
 * <p>
 * Implementations handle specific container formats (MKV, MP4, etc.).
 * The extracted elementary streams are written as raw files suitable for
 * feeding into {@link org.brts.common.m2ts.M2tsWriter}.
 */
public interface MediaSource {
    ...
    record ExtractionResult(
            Path videoEsFile,
            Path audioEsFile,
            int videoStreamTypeByte,
            int audioStreamTypeByte,
            Double frameRateFps,
    ...
    /**
     * Extracts the video and audio elementary streams from the source media
