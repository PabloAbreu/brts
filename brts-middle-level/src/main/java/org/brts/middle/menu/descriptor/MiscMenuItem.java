...
public class MiscMenuItem extends MenuItem {
    ...
    /**
     * Path to a black-and-white PNG icon image.
     * The icon will be loaded and colourised per button state
     * (normal / selected / activated) to produce the final RLE images.
