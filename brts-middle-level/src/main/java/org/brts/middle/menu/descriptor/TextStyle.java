...
/**
 * Text rendering style for menu button labels.
 * All fields are optional — sensible defaults are applied when {@code null}.
 *
 * <h2>Defaults</h2>
 * <ul>
...
public class TextStyle {
     ...
     * Possible values: NONE, RECTANGLE, ROUNDED_RECTANGLE.
     */
    ...
    /**
     * Returns a new {@code TextStyle} that merges this style's non-null fields
     * over the given base (global) style. Fields set on {@code this} take
     * precedence; unset fields fall back to the base.
     */
    ...
    /**
     * Returns a fully-resolved copy of this style where all {@code null}
