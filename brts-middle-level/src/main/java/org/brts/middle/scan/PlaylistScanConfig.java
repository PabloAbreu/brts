...
/**
 * Configuration for playlist scanning heuristics.
 * All duration thresholds are in minutes.
 * <p>
...
public class PlaylistScanConfig {
    ...
    /**
     * Minimum duration (minutes) for a playlist to be considered a feature film.
     * Default: 80 min.
     */
    @Builder.Default
    ...
    /**
     * When the disc is classified as MOVIE, any playlist whose duration is at least
     * this fraction of the longest playlist's duration is considered an interesting
    ...
    /**
     * Maximum allowed ratio between the longest and shortest candidate episodes.
     * If the ratio exceeds this, the candidates are not uniform enough to be
     * auto-detected as a series.  Default: 2.0.
     */
    @Builder.Default
    ...
    /**
     * If true, menu playlists (isMenu=true) are excluded from the results.
     * Default: true.
     */
    @Builder.Default
