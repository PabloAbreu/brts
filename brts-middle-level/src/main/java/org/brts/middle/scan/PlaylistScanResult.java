 ...
 * <p>
 * Contains the auto-detected (or forced) content type and a curated list of
 * "interesting" playlists that most likely represent the main content
 * (feature film + alternate cuts, or TV-series episodes).
 */
@Getter
@Setter
