 ...
 *
 * This file '/data/work/brts/brts-middle-level/src/main/java/org/brts/middle/scan/FirstPlaylistFinder.java' is part of BRTS.
 * ==============================
...
public class FirstPlaylistFinder {
	...
	private static final Set<String> PLAY_REASONS = Set.of("PLAY_PL", "PLAY_PL_PI", "PLAY_PL_PM");

	private static final Set<String> JUMP_REASONS = Set.of("JUMP_OBJECT", "JUMP_TITLE");

	private static final Set<String> CALL_REASONS = Set.of("CALL_OBJECT", "CALL_TITLE");
