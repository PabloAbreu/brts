 ...
 * <p>
 * This model tracks the current page, which buttons are enabled/selected/activated,
 * and pre-decoded button images.  It is the "engine" behind the Swing viewer.
 */
@Getter
@Setter
public class DisplaySetPreviewModel {
    ...
    /**
     * Per-BOG enabled button id.
     * Key = bog index within the current page, Value = enabled button id.
     */
