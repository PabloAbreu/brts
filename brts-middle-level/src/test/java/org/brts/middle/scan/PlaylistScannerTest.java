...
class PlaylistScannerTest {
    ...
    void computeDurationSeconds_singleItem() {
        MoviePlaylist pl = playlist("00001",
                item("00001", 0, 45_000 * 120)); // 120 seconds at 45 kHz
    ...
    void computeDurationSeconds_multipleItems() {
        ...
        MoviePlaylist pl = playlist("00002",
                item("00001", 0, 45_000 * 60),
                item("00002", 45_000 * 10, 45_000 * 40)); // 30s span
        double dur = PlaylistScanner.computeDurationSeconds(pl);
