 ...
 * <li>Synthetic images - generated images produced by
 * SyntheticImageGenerator</li>
 * </ul>
 * 
 * <p>
 * The buffer uses lazy loading with caching to optimize performance when
 * composing
 * multiple frames. Video frames are accessed with automatic looping when the
 * requested
