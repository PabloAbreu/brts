...
/**
 * Codec types found on a Blu-ray stream.
 * Each constant maps to the Blu-ray stream_coding_type byte value.
 */
public enum StreamCodingType {
    ...
    public static StreamCodingType fromByte(int b) {
        for (StreamCodingType t : values()) {
            if (t.codingTypeByte == b) return t;
        }
    ...
    public boolean isAudio() {
        return this == LPCM || this == DOLBY_AC3 || this == DTS
                || this == DOLBY_TRUEHD || this == DOLBY_AC3_PLUS
