...
/**
 * Round-trip test for {@code MovieObject.bdmv}.
 * Writes via {@link MovieObjectsWriter}, re-parses via {@link MovieObjectsParser},
 * and verifies the model is preserved.
 */
class MovieObjectsRoundTripTest {
    ...
    void roundTrip_mnemonicCompile_mixedOperands() throws Exception {
        ...
        // IMM_OP1 should be clear (GPR destination), IMM_OP2 should be set (immediate source)
    ...
    private MovieObjects.NavigationCommand mnemonicCmd(String mnemonic, long op1,
                                                        boolean op1Imm, long op2,
                                                        boolean op2Imm) {
        MovieObjects.NavigationCommand cmd = new MovieObjects.NavigationCommand();
