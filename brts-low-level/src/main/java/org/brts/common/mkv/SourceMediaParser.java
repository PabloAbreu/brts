...
/**
 * Abstract contract for source media parsers.
 * Implementations provide track metadata extracted from different container formats
 * (MKV, MP4, etc.) without coupling the rest of the tool suite to a specific library.
 */
