 ...
 * Composition Segment).  Holds stream/UI model, timeout values, and the full
...
public class IgsInteractiveComposition {
    ...
    private int uiModel;
    /**
     * Composition timeout PTS (33 bits, 90 kHz).
     * Valid only when {@code streamModel == 0}.
     */
    private long compositionTimeoutPts;
    /**
     * Selection timeout PTS (33 bits, 90 kHz).
     * Valid only when {@code streamModel == 0}.
     */
