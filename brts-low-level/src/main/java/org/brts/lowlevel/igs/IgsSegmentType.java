...
/**
 * Segment types found in IGS (Interactive Graphic Stream) and PGS (Presentation
 * Graphic Stream) elementary streams.
 * <p>
 * Each segment in the raw ES begins with a 1-byte type, a 2-byte length, and
 * then type-specific data.  The constants here match the values defined in the
 * Blu-ray specification and implemented by libbluray.
 */
