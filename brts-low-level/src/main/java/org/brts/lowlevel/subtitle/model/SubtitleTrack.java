...
/**
 * A complete subtitle track — an ordered list of {@link SubtitleCue}s plus
 * optional metadata from the source format.
 * <p>
 * This is the common intermediate representation produced by all subtitle
 * parsers, regardless of the source format (SRT, SSA/ASS, etc.).
 */
@Getter
@Setter
...
public class SubtitleTrack {
    ...
    /**
     * Convenience: total duration of the track in milliseconds
     * (based on the last cue's end time).
     */
