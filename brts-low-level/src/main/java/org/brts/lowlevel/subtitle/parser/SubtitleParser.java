 ...
 * <p>
 * Each implementation handles a specific text-based subtitle format (SRT, SSA/ASS, etc.)
 * and produces a format-agnostic {@link SubtitleTrack}.
 */
public interface SubtitleParser {
	...
	/**
	 * Parses subtitle data from an input stream. This overload supports on-the-fly
	 * extraction from container formats (e.g. MKV) where the data is not on disk.
