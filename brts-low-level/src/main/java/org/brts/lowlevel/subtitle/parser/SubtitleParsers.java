...
/**
 * Resolves a {@link SubtitleParser} implementation based on file extension
 * or explicit format name.
 */
public final class SubtitleParsers {
    ...
    /**
     * Returns the appropriate parser for the given subtitle file, based on
     * its extension.
     *
    ...
    public static SubtitleParser forFile(Path file) {
        ...
        throw new IllegalArgumentException(
                "Unsupported subtitle format: " + file.getFileName()
                        + " (supported: .srt, .ssa, .ass)");
    }
