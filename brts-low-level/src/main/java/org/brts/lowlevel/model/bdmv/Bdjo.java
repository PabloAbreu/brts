 ...
 * <p>
 * A BDJO file describes the BD-J application(s) that are launched when
 * a BD-J title is entered. It contains:
 * <ul>
...
public class Bdjo {
    ...
    public static class BdjoApp {
        ...
        /**
         * Raw 10-byte descriptor tag+length header.
         * Preserved for byte-for-byte round-trip fidelity.
         * When writing, if null, the header is computed from the descriptor body length.
         */
