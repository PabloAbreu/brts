...
/**
 * EP_map (Entry Point Map) — enables random access into an M2TS clip.
 * Each {@link EpMapEntry} stores a coarse-grained (SPN=Source Packet Number) anchor
 * aligned to a keyframe, required for seek and chapter navigation.
 */
@Getter
@Setter
public class EpMap {
    ...
    /**
     * A single entry-point anchor within an EP_map stream.
     * The combination of PTS + SPN uniquely identifies a seekable position.
     */
    @Getter
    @Setter
    public static class EpMapEntry {
        ...
        /**
         * I-picture end position offset (3 bits, 0–7).
         * Indicates the relative distance to the end of the I-picture in
