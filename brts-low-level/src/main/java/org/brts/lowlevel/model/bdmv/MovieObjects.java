 ...
 * command program. Objects are referenced from {@code index.bdmv} by their zero-based index.
 */
@Getter
@Setter
public class MovieObjects {
    ...
    /**
     * A single HDMV movie object — a program of navigation commands
     * executed when a title is entered.
     */
    @Getter
    @Setter
     ...
     * <p>
     * This is a JSON-friendly DTO. For rich operand-type analysis and display,
     * convert to {@link ParsedNavigationCommand} via {@link #toParsed()}.
     */
    @Getter
    @Setter
    public static class NavigationCommand {
         ...
         * <p>
         * If {@code rawOpcode} is set (≥ 0), it is used directly.
         * Otherwise the opcode is compiled from the mnemonic. When compiling
         * from a mnemonic without a rawOpcode, operands are assumed immediate
         * (since we have no other information).
         *
