...
/**
 * Decompiles 32-bit HDMV navigation command opcodes (plus their two 32-bit operands) into
 * human-readable mnemonics and descriptions.
 * <p>
 ...
 * <p>
 * This class now delegates to {@link ParsedNavigationCommand} for all formatting and
 * operand-type analysis, which uses the opcode's immediate flags (bits 23/22) instead of
...
public final class NavigationCommandDecompiler {
	 ...
	 * @param opcode 32-bit opcode word (including OperandCount, immediate flags, and
	 * command fields)
	...
	/**
	 * Convenience method: decompile and return only the human-friendly description
	 * string.
	 */
