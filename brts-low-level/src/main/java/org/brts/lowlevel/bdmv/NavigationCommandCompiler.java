 ...
 * </pre> All supported mnemonics are defined in {@link NavigationCommandMnemonic}.
 */
public final class NavigationCommandCompiler {
	...
	/**
	 * Returns the 32-bit opcode word for the given mnemonic, with the OperandCount (bits
	 * 31-29) and immediate-operand flags (bits 23 and 22) set according to the
