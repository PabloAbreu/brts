...
/**
 * A complete PGS Display Set — the collection of all segments between a PCS
 * (Presentation Composition Segment) and the End-Of-Display marker.
 * <p>
 ...
 * </ul>
 * PDS, ODS, WDS, and END segments are structurally identical between PGS and IGS,
 * so we reuse the IGS model classes directly.
 */
@Getter
@Setter
@ToString
